...
def dection():
    ...
    img_dir=r'C:\XXXX_CodeRepository\GraduationDesign_exe\core_Rgnz\train_dir\usr_liujinghai'
    img_path_set=[]
    ...
    # 改为emb_img文件夹的绝对路径  
    emb_dir=r'C:\XXXX_CodeRepository\GraduationDesign_exe\core_Rgnz\emb_img\usr_liujinghai'
